...
def get_game_videos_data(game: str,
    ...
    for annotation in annotations:
        ...
        elif label in constants.shot_classes:
            video_data["frame_index2action"][frame_index] = "Shot"
        elif label in constants.freekick_classes:
            video_data["frame_index2action"][frame_index] = "Free-kick"
        else:
